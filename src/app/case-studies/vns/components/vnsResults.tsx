...
export default function VNSResults() {
    return (
        <div className="bg-white/0 py-16">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className=" p-8 md:p-12 rounded-2xl mb-20">
                        <div className="grid md:grid-cols-[300px_1fr] gap-8 items-start">
                            <div>
                                <p className="archivo-expanded  text-xl text-[#000A1D]">Quang Ho,</p>
                                <p className="archivo-expanded text-xl text-[#000A1D]">Marketing Manager</p>
                            </div>
