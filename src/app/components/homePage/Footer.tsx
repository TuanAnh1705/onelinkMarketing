                    ...
                    <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                        <div className="w-full max-w-[500px] mx-auto lg:mx-0 flex flex-col items-center lg:items-start text-center lg:text-left">
                            ...
                            <div className="flex justify-center lg:justify-start gap-5 mt-6 w-full">
                                ...
                                <Link href="https://www.linkedin.com/company/onelink-marketing/" target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
                                ...
                                <Link href="https://www.behance.net/onelinkmarketi" target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
